...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{figure}[H]
            \begin{center}
                \includegraphics[width=1\textwidth]{tdma_state_diagram.png}
            \end{center}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.8\textwidth]{mesh_topology.jpg}
            \caption{Mesh topology}
        \end{figure}
        \column{0.3\textwidth}
        \begin{figure}[H]
            \includegraphics[width=0.8\textwidth]{ble_mesh_layered_architecture.png}
