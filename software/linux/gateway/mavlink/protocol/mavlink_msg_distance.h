...
#define MAVLINK_MSG_ID_DISTANCE_LEN 6
#define MAVLINK_MSG_ID_DISTANCE_MIN_LEN 6
#define MAVLINK_MSG_ID_2_LEN 6
#define MAVLINK_MSG_ID_2_MIN_LEN 6

#define MAVLINK_MSG_ID_DISTANCE_CRC 187
#define MAVLINK_MSG_ID_2_CRC 187
...
#define MAVLINK_MESSAGE_INFO_DISTANCE { \
    ...
    "DISTANCE", \
    2, \
    {  { "anchor", NULL, MAVLINK_TYPE_UINT16_T, 0, 4, offsetof(mavlink_distance_t, anchor) }, \
...
{
    return mavlink_msg_distance_pack(system_id, component_id, msg, distance->anchor, distance->distance);
}
...
{
    return mavlink_msg_distance_pack_chan(system_id, component_id, chan, msg, distance->anchor, distance->distance);
}
...
static inline void mavlink_msg_distance_send(mavlink_channel_t chan, uint16_t anchor, float distance)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_DISTANCE_LEN];
    _mav_put_float(buf, 0, distance);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_distance_send(chan, distance->anchor, distance->distance);
#else
 ...
 */
static inline void mavlink_msg_distance_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint16_t anchor, float distance)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
