...
class MAVLink_tof_message(MAVLink_message):
        ...
        name = 'TOF'
        fieldnames = ['node_id', 'x', 'y', 'z', 'tof']
        ordered_fieldnames = ['node_id', 'x', 'y', 'z', 'tof']
        fieldtypes = ['int32_t', 'float', 'float', 'float', 'int32_t']
        fielddisplays_by_name = {}
        fieldenums_by_name = {}
        fieldunits_by_name = {}
        format = '<ifffi'
        native_format = bytearray('<ifffi', 'ascii')
        orders = [0, 1, 2, 3, 4]
        lengths = [1, 1, 1, 1, 1]
        array_lengths = [0, 0, 0, 0, 0]
        crc_extra = 178
        unpacker = struct.Struct('<ifffi')
        instance_field = None
        instance_offset = -1

        def __init__(self, node_id, x, y, z, tof):
        ...
        def pack(self, mav, force_mavlink1=False):
                return MAVLink_message.pack(self, mav, 178, struct.pack('<ifffi', self.node_id, self.x, self.y, self.z, self.tof), force_mavlink1=force_mavlink1)
...
class MAVLink(object):
        ...
        def tof_encode(self, node_id, x, y, z, tof):
                '''
                TOF message
                ...
                '''
                return MAVLink_tof_message(node_id, x, y, z, tof)

        def tof_send(self, node_id, x, y, z, tof, force_mavlink1=False):
                '''
                TOF message
                ...
                '''
                return self.send(self.tof_encode(node_id, x, y, z, tof), force_mavlink1=force_mavlink1)
